...
- [ ] - [ ] **Add second top-of-file comment to README.md** — Add a second HTML comment above the existing `<!-- test comment -->` line at the top of README.md, containing the text "test 2". Touch only README.md — nothing under lib/, no other file.
