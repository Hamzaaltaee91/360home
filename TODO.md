...
- [ ] In site/my-offers.html, the nav bar's `.nav-links` currently has only "عروضي" (self-link). Add two more items after it: "تصفح الطلبات" linking to realtor-requests.html, and "الإشعارات" linking to notifications.html. Change nothing else in the file. Touch only site/my-offers.html — nothing under lib/, no other file.
