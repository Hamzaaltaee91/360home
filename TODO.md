...
- [ ] In site/request.html, import getCurrentUserDisplay from ./js/auth.js and insert the signed-in user's display name (full_name, falling back to email) as a span before #signout-btn in the nav, same pattern as dashboard.html lines 72-86. Touch only site/request.html — nothing under lib/, no other file.
- [ ] In site/offer.html, import getCurrentUserDisplay from ./js/auth.js and insert the signed-in user's display name (full_name, falling back to email) as a span before #signout-btn in the nav, same pattern as dashboard.html lines 72-86. Touch only site/offer.html — nothing under lib/, no other file.
- [ ] In site/messages.html, import getCurrentUserDisplay from ./js/auth.js and insert the signed-in user's display name (full_name, falling back to email) as a span before #signout-btn in the nav, same pattern as dashboard.html lines 72-86. Touch only site/messages.html — nothing under lib/, no other file.
- [ ] In site/notifications.html, import getCurrentUserDisplay from ./js/auth.js and insert the signed-in user's display name (full_name, falling back to email) as a span before #signout-btn in the nav, same pattern as dashboard.html lines 72-86. Touch only site/notifications.html — nothing under lib/, no other file.
- [ ] In site/create-offer.html, import getCurrentUserDisplay from ./js/auth.js and insert the signed-in user's display name (full_name, falling back to email) as a span before #signout-btn in the nav, same pattern as dashboard.html lines 72-86. Touch only site/create-offer.html — nothing under lib/, no other file.
- [ ] In site/my-offers.html, import getCurrentUserDisplay from ./js/auth.js and insert the signed-in user's display name (full_name, falling back to email) as a span before #signout-btn in the nav, same pattern as dashboard.html lines 72-86. Touch only site/my-offers.html — nothing under lib/, no other file.
- [ ] In site/realtor-requests.html, import getCurrentUserDisplay from ./js/auth.js and insert the signed-in user's display name (full_name, falling back to email) as a span before #signout-btn in the nav, same pattern as dashboard.html lines 72-86. Touch only site/realtor-requests.html — nothing under lib/, no other file.
- [ ] In site/request-new.html, import getCurrentUserDisplay from ./js/auth.js and insert the signed-in user's display name (full_name, falling back to email) as a span before #signout-btn in the nav, same pattern as dashboard.html lines 72-86. Touch only site/request-new.html — nothing under lib/, no other file.
- [ ] In site/edit-request.html, import getCurrentUserDisplay from ./js/auth.js and insert the signed-in user's display name (full_name, falling back to email) as a span before #signout-btn in the nav, same pattern as dashboard.html lines 72-86. Touch only site/edit-request.html — nothing under lib/, no other file.
- [ ] In site/become-realtor.html, import getCurrentUserDisplay from ./js/auth.js and insert the signed-in user's display name (full_name, falling back to email) as a span before #signout-btn in the nav, same pattern as dashboard.html lines 72-86. Touch only site/become-realtor.html — nothing under lib/, no other file.
